...
const { useState, useContext, useRef, Fragment } = require("react");

export const TheAddPassForm = ({
    comfirmState,
    setComfirmState,
    savingPassword,
    runFunction
                    ...
                    <div className="">
                      ...
                      <div className="mt-3 text-center">
                        ...
                        <div className="m-5 text-sm text-black">
                          ...
                          <input value={savingPassword} className='w-full  border focus:outline-none focus:border-white p-2 m-0  text-base block border-gray-700 rounded-md' type="text" placeholder='enter here app Id' />
                        </div>
                        <div className="m-5 text-sm text-black">
